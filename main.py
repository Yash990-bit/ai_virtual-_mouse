    ...
    while True:
        ...
        if len(lm_list) != 0:
            ...
            # B. LEFT CLICK: Index + Middle Pinch
                ...
                # Increased sensitivity (45 instead of 40)
                if dist < 45: 
                    cv2.circle(img, (x1, y1), 20, (0, 255, 0), cv2.FILLED)
                    cv2.putText(img, "CLICK!", (x1+20, y1), cv2.FONT_HERSHEY_PLAIN, 3, (0, 255, 0), 4)
                    mouse.click()
                    time.sleep(0.1)
                else:
                    cv2.putText(img, "PINCH TO CLICK", (x1+20, y1), cv2.FONT_HERSHEY_PLAIN, 1.5, (0, 255, 255), 2)

            # C. RIGHT CLICK: 3 Fingers Up
            elif fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 1 and fingers[4] == 0:
                cv2.putText(img, "RIGHT CLICK", (x1+20, y1), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 255), 3)
                mouse.right_click()
                time.sleep(0.3)
